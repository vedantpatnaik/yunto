...
export default function CalendarAllCreatorPage() {
  ...
  return (
    <>
      ...
      <div className="absolute left-[609px] top-[246px] h-[45px] w-[170px] rounded-[28px] bg-black/90">
      ...
      <div className="absolute left-[875px] top-[246px] h-[45px] w-[124px] rounded-[24px] border-[0.5px] border-[#CCCCCC] bg-white">
      ...
      <div className="absolute left-[281.9px] top-[331px] h-[45px] w-[108px] rounded-[28px] border border-[#D9D9D9] bg-white/90">
        <span className="absolute left-[14px] top-[13px] text-[14px] font-light leading-[18px] text-black">October</span>
      ...
      <div className="absolute left-[749px] top-[334px] h-[39px] w-[227px] rounded-[21px] border-[0.6px] border-[#D9D9D9] bg-white">
        ...
        week.map((day, ci) => {
          ...
          return (
            ...
            >
              ...
              {isTitan && (
                <span className="absolute left-[3.7px] top-[92.9px] flex h-[23.5px] w-[86.4px] items-center gap-[3px] rounded-[7.5px] bg-[#DC96F2]/[0.38] px-[6px]">
                  <img src={instagram} alt="" className="h-[11.3px] w-[11.3px]" />
                  <span className="text-[11.6px] font-normal leading-none text-black/90">{items[0]?.title ?? ""}</span>
                </span>
              )}

              {isVideo && (
                <span className="absolute left-[3.7px] top-[92px] flex h-[23.5px] w-[86.4px] items-center gap-[3px] rounded-[7.5px] bg-[#9EE4AD]/[0.38] px-[6px]">
                  <Youtube className="h-[14px] w-[14px] text-[#FF0000]" strokeWidth={1.6} />
                  <span className="text-[11.6px] font-normal leading-none text-black/90">{items[1]?.title ?? ""}</span>
                </span>
              )}
            </div>
          );
      ...
      <button className="absolute left-[1321px] top-[257px] flex h-[28px] w-[28px] items-center justify-center rounded-[16px] bg-white">
      ...
      <div className="absolute left-[1031px] top-[296px] h-[546px] w-[312px] rounded-[12px] border border-[#EAEAEA] bg-white">
        ...
        <span className="absolute left-[9px] top-[41px] flex h-[25px] w-[92px] items-center gap-[3px] rounded-[8px] bg-[#E0E49E]/[0.38] px-[6px]">
          ...
          <span className="text-[12.4px] font-normal leading-none text-black/90">{items[2]?.title ?? ""}</span>
        </span>
        {/* body */}
