...
export default function SalesHome() {
  ...
  const goLeads = () => router.push("/leads/leads");
  const goRequests = () => router.push("/campaigns/all-requests");
        ...
        >
          ...
          <Abs x={0} y={-BODY_Y} w={FRAME_W} h={CONTENT_BOTTOM}>
            ...
            <SeeLink
              ...
              w={44.56}
              label="See all"
              onPress={() => router.push("/people/assign-creators")}
            />
            ...
            <Abs x={23} y={1516} w={161.5} h={110} radius={24} bg="#e4ecf4" border="rgba(217,232,245,0.5)" borderWidth={1} style={styles.tile}>
              <Pressable onPress={() => router.push("/services/videographers")} style={styles.fill}>
            ...
            <Abs x={196.5} y={1516} w={161.5} h={110} radius={24} bg="#f6f3e6" border="rgba(252,244,217,0.5)" borderWidth={1} style={styles.tile}>
              <Pressable onPress={() => router.push("/services/editors")} style={styles.fill}>
                <Abs x={17} y={17} w={32} h={32} radius={16} bg={GLASS_60} center>
            ...
            <SeeLink
              ...
              w={44.56}
              label="See all"
              onPress={() => router.push("/profile/reminders-list")}
            />
