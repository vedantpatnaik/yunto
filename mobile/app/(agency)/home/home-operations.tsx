  ...
  return (
    <Screen height={FRAME_H} background={PAGE_BG} scroll>
      ...
      <Abs x={0} y={BODY_Y} w={FRAME_W} h={BODY_H} style={styles.clip}>
        ...
        >
          ...
          <Abs x={0} y={-BODY_Y} w={FRAME_W} h={CONTENT_BOTTOM}>
            ...
            <Pressable onPress={() => router.push("/leads/leads")} style={styles.alertCard}>
            ...
            <Abs x={20} y={505} w={335} h={314} radius={32} bg={REVENUE_BG} style={styles.clip}>
              ...
              <Abs x={25} y={171} w={285} h={118} radius={20} bg={GLASS_40}>
                ...
                <Pressable onPress={() => router.push("/home/set-revenue-target")} style={styles.setTarget}>
            ...
            <Pressable onPress={() => router.push("/campaigns/all-requests")} style={styles.seeRequest}>
              <Txt size={14} weight="semibold" font="inter" color={INK_60} lineHeight={20}>
                See Request
              </Txt>
            </Pressable>

            <Pressable onPress={() => router.push("/services/videographers")} style={styles.serviceLeft}>
            ...
            <Pressable onPress={() => router.push("/services/editors")} style={styles.serviceRight}>
              <Abs x={17} y={17} w={32} h={32} radius={16} bg={GLASS_60} center>
            ...
            <Pressable onPress={() => router.push("/profile/reminders-list")} style={styles.remindersSeeAll}>
              <Txt size={14} weight="semibold" font="inter" color={INK_60} lineHeight={20}>
                See all
              </Txt>
            </Pressable>
      ...
      <Abs x={9} y={765} w={357} h={72} radius={32} bg={GLASS_54} style={styles.tabBar}>
        ...
        <Pressable onPress={() => router.push("/payments/invoice-hub")} style={[styles.tabItem, { left: 106 }]}>
          <Feather name="credit-card" size={24} color={INK} />
        </Pressable>
        <Pressable onPress={() => router.push("/people/people-overview")} style={[styles.tabItem, { left: 227 }]}>
          <Feather name="users" size={24} color={INK} />
        </Pressable>
        <Pressable onPress={() => router.push("/profile/profile-home")} style={[styles.tabItem, { left: 308 }]}>
      ...
      <Abs x={157} y={736} w={60} h={60} radius={30} bg={PAGE_BG} center>
        <Pressable onPress={() => router.push("/profile/add-reminder")} style={styles.fab}>
