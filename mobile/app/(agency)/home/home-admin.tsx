...
export default function HomeAdmin() {
  ...
  return (
    <Screen height={FRAME_H} background={PAGE} scroll>
      ...
      <Pressable
        onPress={() => router.push("/people/people-overview")}
        accessibilityRole="button"
      ...
      <Pressable
        onPress={() => router.push("/services/editors")}
        accessibilityRole="button"
      ...
      <Pressable
        onPress={() => router.push("/payments/invoice-hub")}
        accessibilityRole="button"
      ...
      <Pressable
        onPress={() => router.push("/profile/profile-home")}
        accessibilityRole="button"
