...
export default function AgencySetRevenueTargetScreen() {
  ...
  return (
    <Screen height={FRAME_H} background={BG} scroll>
      ...
      <Abs x={0} y={BODY_Y} w={FRAME_W} h={BODY_H} style={{ overflow: "hidden" }}>
        ...
        >
          ...
          <View style={{ position: "absolute", left: 0, top: -BODY_Y, width: FRAME_W, height: CONTENT_BOTTOM }}>
            ...
            {/* ------------------------- Leads nudge ----------------------- */}
            <Pressable
              onPress={() => router.push("/leads/leads")}
              style={{
            ...
            <SeeAll x={306.44} y={860} onPress={() => router.push("/people/assign-creators")} />
            ...
            <SeeAll x={309.44} y={1589} onPress={() => router.push("/profile/reminders-list")} />
      ...
      <Pressable onPress={() => router.push("/campaigns/active-campaigns")} style={{ position: "absolute", left: 115, top: 818 }}>
      ...
      <Pressable onPress={() => router.push("/payments/invoice-hub")} style={{ position: "absolute", left: 236, top: 818 }}>
        <Feather name="pie-chart" size={24} color={NAV_OFF} />
      </Pressable>
      <Pressable onPress={() => router.push("/profile/profile-home")} style={{ position: "absolute", left: 317, top: 818 }}>
